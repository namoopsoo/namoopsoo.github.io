...
So I wonder would you use a prompt template with the name of the person maybe as an input variable maybe, prior to a free chat open ended conversation?

I am particularly super curious can we use prompt engineering to convey that the person on the other end is like a customer, so they might say personal pronouns "my" etc ? Using https://langchain.readthedocs.io/en/latest/modules/memory/examples/chatgpt_clone.html to help try this.
