...
## Housing scarcity
VC funds are [buying](https://www.reddit.com/r/pcmasterrace/comments/1px9xwx/private_equity_is_killing_private_ownership_first/) up private properties, taking housing off the market, driving up housing costs through additional scarcity and pushing more people to renting.

Also, shared algorithms for rent pricing are a proxy for collusion, possibly inadvertent, but raising prices.

## Loneliness 

## Health insurance disconnect
We have new transparency laws passed but perhaps people dont know about them yet. 

Not yet transitioned to vqlue based cqre, so many providers are incentivized to paper patients with mountqins of itemization paper cuts. Value based care would open up pay for outcomes.
