...
{{< row >}}
{{< column >}}
{{< figure src="https://s3.amazonaws.com/my-blog-content/2025-12-11-skip-jetlag/before.jpeg" width="50%">}}
{{< /column >}}

{{< column >}}
{{< figure src="https://s3.amazonaws.com/my-blog-content/2025-12-11-skip-jetlag/hide.jpeg" width="50%">}}
{{< /column >}}

{{< column >}}
{{< figure src="https://s3.amazonaws.com/my-blog-content/2025-12-11-skip-jetlag/choose.jpeg" width="50%">}}
{{< /column >}}

{{< column >}}
{{< figure src="https://s3.amazonaws.com/my-blog-content/2025-12-11-skip-jetlag/after.jpeg" width="50%">}}
{{< /column >}}
{{< /row >}}
...
## Drag and win
This was kind of baffling, but while just messing around with the long clicks, I noticed I could see the domain when dragging them. Actually I remember noticing this when reading an article in my paid-for The Atlantic app<sup>[2](#references)</sup> too. But then I had the other super random idea to drag the link with my index finger and open up the app switcher with my thumb, and drag the link into my Notes App. And boom somehow that actually worked ! And I was able to see the link. 
