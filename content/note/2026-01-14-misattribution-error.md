...
But by solving ambiguity, Scrum introduces problem of boredom , reduces collaboration, and perhzps people still end up getting creative along the edges in their spare time so Scrum only papers over the problem but it still exists in reality.
