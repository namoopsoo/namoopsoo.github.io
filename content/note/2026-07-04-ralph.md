...
Im only writing this about Ralph Loops so far but the real puzzle is where does Steve Yegge's Gas Town fit into this since he has been building what he sees as the next evolutionary step, a kubernetes ralph loop with tasks in a block chain graph. 

Another voice inthrs community is david haremeier hanson, having recently Discussed his preference for on agentic first work flow in a promottic programmer interview. But his one of the voices behind shape up [5], where tackling the uncertainty in project is the design work done by one or two individuals, called shoping, and then a highly constrained project is then handed off to on implementation team. in that interview, DHH states i recall that he sees shaping as like 80% and then the final de-risked execution as the final 20% iso if that is the perspective of shape up from mong years ago, then I wonder what D.H.H. And the others, jason fried, would sog about the ambitions project ideas like Gas Town that appear to forego shaping.


I am still going to give benefit to the doubt and keep trying to understand, but for now as with questioning the Underpants Gnomes Im still seeing puzzled at the "....." before the Profit .
...
4. todo, Russel Peters how to bake a cake link
