---
title: Passing large dataframes with dbutils.notebook.run in databricks
date: 2023-02-25
---

_(Note, originally posted this [here](https://github.com/namoopsoo/handy/blob/master/databricks-spark/dbutils-notebook-run-and-global-temp-view.md) but cross posting here too)_
