...
So I sent a prompt to GPT 4, thinking hey let's create a dictionary entry one might find a future where actual parking lots for "cars" went away because when we all adopted self driving cars, the efficiency meant that these cars would no longer need a square of pavement to collect their dust. I guess we'll see  what happens .
