...
What is science? Does that imply putting knowledge into the public domain? 

And If you solve a problem using machine learning, regardless of whether the end model maybe these are more like local optimizations ? 

This has been a topic of discussion around the GPT papers. 

They are squeezing every bit of entropy out and achieving an amazing magic trick.

Philosophyical aspect, also saw it recently in this article about rocketry and Elon. 
