...
{{< figure src="https://s3.amazonaws.com/my-blog-content/2026-02-14--coldest/2026-02-14--coldest_4_0.png" width="90%">}}
...
This blog post, unlike others in the past, was built purely from the jupyter notebook<sup>[4](#references)</sup> in git, using `jupyter nbconvert`, except for uploading the final images to my cdn, which hopefully I can automate too one day.
